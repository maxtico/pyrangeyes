...
for ext in ['png']: #, 'pdf']:
    ...
    prp.plot([gr, w, z, mapped_t1, mapped_t2, t1, t2, mapped_w, mapped_z],
         id_col='transcript_id',
         color_col='transcript_id',
         title_chr='Sequence: {chrom}',
         warnings=False,
         y_labels=['g', 'w', 'z', 't1.map_to_global(g,id)', 't2.map_to_global(g,id)', "t1", "t2", 'w.map_to_local(g,id)', 'z.map_to_local(g,id)'],
